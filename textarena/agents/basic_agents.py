...
class OpenRouterAgent(Agent):
    ...
    def __init__(self, model_name: str, system_prompt: Optional[str] = STANDARD_GAME_PROMPT, verbose: bool = False, api_key: str|None=None, base_url: str|None=None, **kwargs):
        ...
        self.client = OpenAI(
            ...
            api_key=api_key,
            default_headers={
                "HTTP-Referer": "https://github.com/chess-prompt-arena",
                "X-Title": "Chess Prompt Arena"
            }
        )
...
class GeminiAgent(Agent):
    ...
    def __init__(self, model_name: str, system_prompt: Optional[str]=STANDARD_GAME_PROMPT, verbose: bool=False, generation_config: Optional[dict]=None, api_key: str|None=None):
        """
    ...
    def _make_request(self, observation: str) -> Tuple[str, int, int, int]:
        ...
        # Handle token counting for Gemini API
        try:
            # Try to access usage_metadata (newer Gemini API)
            ...
            # Fallback for older API versions
                ...
                # If no usage info available, return zeros
                input_tokens = 0
                output_tokens = 0
                total_tokens = 0
        ...
        return response.text.strip(), input_tokens, output_tokens, total_tokens
